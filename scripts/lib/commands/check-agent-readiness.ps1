...
Invoke-ExitAwareCheck -Label "Object validators" -ScriptPath (Join-Path $Root "scripts\lib\commands\validate-failure-log.ps1") -Arguments @{ Root = $Root }
Invoke-ExitAwareCheck -Label "Lesson validators" -ScriptPath (Join-Path $Root "scripts\lib\commands\validate-lessons.ps1") -Arguments @{ Root = $Root }
Invoke-ExitAwareCheck -Label "Routing validators" -ScriptPath (Join-Path $Root "scripts\lib\commands\validate-routing-v1.ps1") -Arguments @{ Root = $Root }
Invoke-ExitAwareCheck -Label "Skill contracts" -ScriptPath (Join-Path $Root "scripts\lib\commands\validate-skill-contracts.ps1") -Arguments @{ Root = $Root }
