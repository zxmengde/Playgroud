...
Invoke-EvalScript -Name "external_mechanism_review_check" -ScriptPath (Join-Path $Root "scripts\lib\commands\eval-external-mechanism-review-check.ps1")
Invoke-EvalScript -Name "research_memo_quality" -ScriptPath (Join-Path $Root "scripts\lib\commands\eval-research-memo-quality.ps1")
Invoke-EvalScript -Name "uiux_review_quality" -ScriptPath (Join-Path $Root "scripts\lib\commands\eval-uiux-review-quality.ps1")
