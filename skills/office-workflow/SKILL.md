...
Before creating or editing office artifacts, identify the audience, file type, structure, tone, visual standard, editability requirement, and validation method. Use `intent-interviewer` for reports, slide decks, formal documents, or tasks with unclear audience.
