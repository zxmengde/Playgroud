...
本索引用于 Codex 工作方式、能力差距、复盘和本地系统改进记录。它与科研资料分离，避免把系统规则来源和科研证据混同。

| 日期 | 标题 | 状态 | 路径 |
| --- | --- | --- | --- |
| 2026-04-25 | 个人 Agent 自我改进反馈与落地记录 | active | `docs/knowledge/items/2026-04-25-personal-agent-self-improvement-feedback.md` |
