...
evidence: `docs/workflows/knowledge.md`; `docs/core/adoption-proof-standard.md`; `docs/validation/adoption-proof-fixtures.md`
integration_proof: `docs/validation/adoption-proof-fixtures.md` 的 `Positive Knowledge Promotion` 和 `docs/knowledge/promotion-ledger.md` 的 `KP-20260503-002 -> KP-20260503-003`。
...
evidence: `docs/tasks/board.md`; `docs/core/adoption-proof-standard.md`; `docs/validation/adoption-proof-fixtures.md`
integration_proof: `docs/validation/adoption-proof-fixtures.md` 的 `Positive Task Attempt Lifecycle`；当前 `ATT-20260503-002` 已取消，`ATT-20260503-003` 跟随本轮状态收尾。
...
evidence: `docs/knowledge/research/research-queue.md`; `docs/knowledge/research/run-log.md`; `docs/validation/adoption-proof-fixtures.md`
integration_proof: `docs/validation/adoption-proof-fixtures.md` 的 `Positive Research Queue Lifecycle`；`RQ-20260503-002` 经 run log review gate 进入 `blocked`。
