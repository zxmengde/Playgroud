---
name: aris-skills-codex-patent-review
...
### Merged Sources
- `aris-patent-review`: 201 lines, sha `b209ed7e1405914b`, source-overlap `0.95`. Trigger: Get an external patent examiner review of a patent application. Use when user says \"专利审查\", \"patent review\", \"审查意见\", \"examiner review\", or wants critical feedback on patent claims and specification.
...
- Source-specific retained points from `aris-patent-review`:
