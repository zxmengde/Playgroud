---
name: aris-skills-codex-pixel-art
...
### Merged Sources
- `aris-pixel-art`: 137 lines, sha `28a74624ca5cf067`, source-overlap `0.99`. Trigger: Generate pixel art SVG illustrations for READMEs, docs, or slides. Use when user says "画像素图", "pixel art", "make an SVG illustration", "README hero image", or wants a cute visual.
...
- Source-specific retained points from `aris-pixel-art`:
