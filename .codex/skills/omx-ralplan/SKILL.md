...
Replaces `omx-plugin-ralplan`.

### Retained Rules
- Use for consensus planning before high-risk or ambiguous Ralph work.
- Define acceptance criteria, test spec, scope, constraints, and unresolved questions before implementation.
- When review findings return, treat them as first-class planning input rather than patching ad hoc.
