---
name: aris-skills-codex-paper-figure
...
### Merged Sources
- `aris-paper-figure`: 280 lines, sha `f8c2cc35c890c585`, source-overlap `0.98`. Trigger: Generate publication-quality figures and tables from experiment results. Use when user says \"画图\", \"作图\", \"generate figures\", \"paper figures\", or needs plots for a paper.
- `aris-skills-codex-claude-review-paper-figure`: 287 lines, sha `bb25582bfafd8a69`, source-overlap `0.95`. Trigger: Generate publication-quality figures and tables from experiment results. Use when user says \"画图\", \"作图\", \"generate figures\", \"paper figures\", or needs plots for a paper.
- `aris-skills-codex-gemini-review-paper-figure`: 287 lines, sha `2c64e62650d3e8e2`, source-overlap `0.95`. Trigger: Generate publication-quality figures and tables from experiment results. Use when user says \"画图\", \"作图\", \"generate figures\", \"paper figures\", or needs plots for a paper.
...
- Source-specific retained points from `aris-paper-figure`:
  - **REVIEWER_MODEL = `gpt-5.4`** — Model used via Codex MCP for figure quality review.
  - 'text.usetex': False, # set True if LaTeX is available
  - config: {"model_reasoning_effort": "xhigh"}
  - ├── paper_plot_style.py # shared style config
- Source-specific retained points from `aris-skills-codex-claude-review-paper-figure`:
  - > Override for Codex users who want **Claude Code**, not a second Codex agent, to act as the reviewer. Install this package **after** `skills/skills-codex/*`.
  - **REVIEWER_MODEL = `claude-review`** — Claude reviewer invoked through the local `claude-review` MCP bridge. Set `CLAUDE_REVIEW_MODEL` if you need a specific Claude model override.
  - 'text.usetex': False, # set True if LaTeX is available
  - mcp__claude-review__review_start:
- Source-specific retained points from `aris-skills-codex-gemini-review-paper-figure`:
