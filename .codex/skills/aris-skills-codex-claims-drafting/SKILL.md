---
name: aris-skills-codex-claims-drafting
...
### Merged Sources
- `aris-claims-drafting`: 226 lines, sha `4eaac106a8cab1d7`, source-overlap `0.96`. Trigger: Draft patent claims for an invention. Use when user says \"撰写权利要求\", \"draft claims\", \"写权利要求书\", \"claim drafting\", or wants to create patent claims. The core skill of the patent pipeline.
...
- Source-specific retained points from `aris-claims-drafting`:
