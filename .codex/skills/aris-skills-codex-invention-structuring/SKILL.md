---
name: aris-skills-codex-invention-structuring
...
### Merged Sources
- `aris-invention-structuring`: 187 lines, sha `4dd3b6d0c1482b3c`, source-overlap `0.96`. Trigger: Structure a raw invention idea into a formal invention disclosure. Use when user says \"构建发明\", \"structure invention\", \"发明构建\", \"invention disclosure\", or wants to formalize a rough idea into a patent-ready structure.
...
- Source-specific retained points from `aris-invention-structuring`:
