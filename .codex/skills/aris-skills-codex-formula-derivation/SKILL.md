---
name: aris-skills-codex-formula-derivation
...
### Merged Sources
- `aris-formula-derivation`: 280 lines, sha `649943aeb88d114d`, source-overlap `1.00`. Trigger: Structures and derives research formulas when the user wants to 推导公式, build a theory line, organize assumptions, turn scattered equations into a coherent derivation, or rewrite theory notes into a paper-ready formula document. Use when the derivation target is
