---
name: aris-skills-codex-auto-review-loop-minimax
...
### Merged Sources
- `aris-auto-review-loop-minimax`: 292 lines, sha `1888521df63ab95f`, source-overlap `0.96`. Trigger: Autonomous multi-round research review loop using MiniMax API. Use when you want to use MiniMax instead of Codex MCP for external review. Trigger with "auto review loop minimax" or "minimax review".
...
- Source-specific retained points from `aris-auto-review-loop-minimax`:
