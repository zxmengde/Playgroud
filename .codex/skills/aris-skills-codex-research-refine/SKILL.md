---
name: aris-skills-codex-research-refine
...
### Merged Sources
- `aris-research-refine`: 742 lines, sha `3de5a1505b17dcbb`, source-overlap `0.89`. Trigger: Turn a vague research direction into a problem-anchored, elegant, frontier-aware, implementation-oriented method plan via iterative GPT-5.4 review. Use when the user says "refine my approach", "帮我细化方案", "decompose this problem", "打磨idea", "refine research plan
- `aris-skills-codex-claude-review-research-refine`: 672 lines, sha `78b5e6c1de573b78`, source-overlap `0.97`. Trigger: Turn a vague research direction into a problem-anchored, elegant, frontier-aware, implementation-oriented method plan via iterative GPT-5.4 review. Use when the user says \"refine my approach\", \"帮我细化方案\", \"decompose this problem\", \"打磨idea\", \"refine rese
- `aris-skills-codex-gemini-review-research-refine`: 672 lines, sha `ca3f7201b14850b5`, source-overlap `0.96`. Trigger: Turn a vague research direction into a problem-anchored, elegant, frontier-aware, implementation-oriented method plan via iterative Gemini review. Use when the user says \"refine my approach\", \"帮我细化方案\", \"decompose this problem\", \"打磨idea\", \"refine resea
...
- Source-specific retained points from `aris-research-refine`:
  ...
  - Long-running refinement sessions may fail mid-way (e.g., API timeout, context compaction, or session interruption). To avoid losing completed work, persist state to `refine-logs/REFINE_STATE.json` after each phase bounda
  - | `phase` | `"anchor"` / `"proposal"` / `"review"` / `"refine"` / `"done"` | Last **completed** phase |
- Source-specific retained points from `aris-skills-codex-claude-review-research-refine`:
  - > Override for Codex users who want **Claude Code**, not a second Codex agent, to act as the reviewer. Install this package **after** `skills/skills-codex/*`.
  - -> Phase 1 (Claude): Scan grounding papers -> identify technical gap -> choose the sharpest route -> write focused proposal
  - **REVIEWER_MODEL = `claude-review`** — Claude reviewer invoked through the local `claude-review` MCP bridge. Set `CLAUDE_REVIEW_MODEL` if you need a specific Claude model override.
  - mcp__claude-review__review_start:
- Source-specific retained points from `aris-skills-codex-gemini-review-research-refine`:
