---
name: "doc"
description: "Use as the DOCX-specific stage specialist when a Word `.docx` file must be read, created, edited, rendered, or visually checked. Pair with `office-workflow` for broader office tasks; do not trigger for PDF, slides, spreadsheets, or generic Markdown."
metadata:
