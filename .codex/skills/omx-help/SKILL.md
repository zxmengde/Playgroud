...
Replaces `omx-plugin-help`.

### Retained Rules
- Use as the user-facing index for OMX commands and skills.
- Show actual available commands, not aspirational entries.
- Group by user task: plan, implement, review, research, team, wiki, visual, diagnostics, setup.
