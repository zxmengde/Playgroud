---
name: aris-skills-codex-idea-discovery-robot
...
### Merged Sources
- `aris-idea-discovery-robot`: 363 lines, sha `e4eedf4fa565e0d4`, source-overlap `0.98`. Trigger: Workflow 1 adaptation for robotics and embodied AI. Orchestrates robotics-aware literature survey, idea generation, novelty check, and critical review to go from a broad robotics direction to benchmark-grounded, simulation-first ideas. Use when user says \"rob
- `aris-skills-codex-gemini-review-idea-discovery-robot`: 363 lines, sha `1b59ed4e1ce1c995`, source-overlap `0.99`. Trigger: Workflow 1 adaptation for robotics and embodied AI. Orchestrates robotics-aware literature survey, idea generation, novelty check, and critical review to go from a broad robotics direction to benchmark-grounded, simulation-first ideas. Use when user says \\\"r
...
- Source-specific retained points from `aris-idea-discovery-robot`:
  - **REVIEWER_MODEL = `gpt-5.4`** — External reviewer model via Codex MCP
  - /run-experiment ← if infrastructure exists
  - > - **[Output Versioning Protocol](../shared-references/output-versioning.md)** — write timestamped file first, then copy to fixed name
  - > - **[Output Manifest Protocol](../shared-references/output-manifest.md)** — log every output to MANIFEST.md
- Source-specific retained points from `aris-skills-codex-gemini-review-idea-discovery-robot`:
