...
Replaces `omx-plugin-note`.

### Retained Rules
- Use for quick local notes that are less formal than a skill or wiki page.
- Capture source, context, date, and why the note may matter later.
- Do not promote one-off facts to long-term knowledge without a later review step.
