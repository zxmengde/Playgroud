---
name: aris-skills-codex-patent-pipeline
...
### Merged Sources
- `aris-patent-pipeline`: 344 lines, sha `da44ef70fb82224f`, source-overlap `1.00`. Trigger: Full patent drafting pipeline from invention description to jurisdiction-formatted filing documents. Supports CN (CNIPA), US (USPTO), EP (EPO). Supports invention patents and utility models. Use when user says \"写专利\", \"patent pipeline\", \"专利申请\", \"draft pa
...
- Source-specific retained points from `aris-patent-pipeline`:
  - (search) (verify) (structure) (claims) (description) (examiner) (compile)
  - ┌→ /experiment-bridge → /auto-review-loop → /paper-writing (publish track)
  - └→ /patent-pipeline → [file patent] (patent track)
