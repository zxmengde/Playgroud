---
name: aris-skills-codex-figure-description
...
### Merged Sources
- `aris-figure-description`: 138 lines, sha `9263820f69125bf7`, source-overlap `1.00`. Trigger: Process user-provided patent figures and generate formal drawing descriptions. Use when user says \"附图处理\", \"figure description\", \"附图说明\", \"drawings description\", or wants to describe patent figures with reference numerals.
