---
name: aris-skills-codex-meta-optimize
...
### Merged Sources
- `aris-meta-optimize`: 253 lines, sha `bb4f8f7fce7c4c8c`, source-overlap `0.96`. Trigger: Analyze ARIS usage logs and propose optimizations to SKILL.md files, reviewer prompts, and workflow defaults. Outer-loop harness optimization inspired by Meta-Harness (Lee et al., 2026). Use when user says \"优化技能\", \"meta optimize\", \"improve skills\", \"分析使
...
- Source-specific retained points from `aris-meta-optimize`:
