---
name: aris-skills-codex-embodiment-description
...
### Merged Sources
- `aris-embodiment-description`: 129 lines, sha `20bf9bcd2c5fd9ae`, source-overlap `1.00`. Trigger: Write detailed embodiment descriptions for patent specifications. Use when user says \"撰写实施例\", \"write embodiment\", \"实施例描述\", \"detailed description\", or wants to describe how to practice an invention.
