---
name: aris-skills-codex-paper-slides
description: "ARIS paper-workflow slide generator for conference talks from a compiled paper, with beamer PDF, editable PPTX, speaker notes, full talk script, resume state, and ARIS checkpoints. Use for explicit ARIS paper workflows, Chinese paper-slide requests, or when state persistence is needed. Use `ai-research-20-ml-paper-writing-presenting-conference-talks` for lightweight AI-Research-SKILLs talk guidance outside ARIS."
...
### Merged Sources
- `aris-paper-slides`: 598 lines, sha `5db71b6b4fb1e708`, source-overlap `0.94`. Trigger: Generate conference presentation slides (beamer LaTeX → PDF + editable PPTX) from a compiled paper, with speaker notes and full talk script. Use when user says \"做PPT\", \"做幻灯片\", \"make slides\", \"conference talk\", \"presentation slides\", \"生成slides\", \"写
- `aris-skills-codex-gemini-review-paper-slides`: 580 lines, sha `36a95efa1308777c`, source-overlap `0.96`. Trigger: Generate conference presentation slides (beamer LaTeX → PDF + editable PPTX) from a compiled paper, with speaker notes and full talk script. Use when user says \"做PPT\", \"做幻灯片\", \"make slides\", \"conference talk\", \"presentation slides\", \"生成slides\", \"写
...
- Source-specific retained points from `aris-paper-slides`:
  - Optional: Style reference (`— style-ref: <source>`, opt-in)
  - Lets the user steer the talk's **structural** rhythm (story beats, theorem density, figure density inherited from the source paper) toward a reference paper. **Default OFF — when the user does not pass `— style-ref`, do
...
- Source-specific retained points from `aris-skills-codex-gemini-review-paper-slides`:
