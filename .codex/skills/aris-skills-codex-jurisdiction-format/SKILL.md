---
name: aris-skills-codex-jurisdiction-format
...
### Merged Sources
- `aris-jurisdiction-format`: 192 lines, sha `2adeb10879dc31f3`, source-overlap `1.00`. Trigger: Compile patent application into jurisdiction-specific filing format. Use when user says \"格式转换\", \"jurisdiction format\", \"国家格式\", \"compile patent\", or wants formatted patent documents for CN/US/EP filing.
